...
object GlobalRes {
    ...
    private var modulesDependencies = mapOf<String, List<String>>()

    fun setModuleDependencies(dependencies: Map<String, List<String>>) {
        modulesDependencies = dependencies
    }

    fun setModuleColors(colors: Map<String, Map<String, String>>) {
        moduleColors = colors
    }

    fun searchInAndroidColors(color: String): String? {
        return androidColors[color.substringAfter("/")]
    }

    fun searchInModuleColors(color: String, root: String) : String? {
        for (module in modulesDependencies[root].orEmpty()) {
            return moduleColors[module]?.get(color) ?: continue
        }
        return null
    }

    //https://gist.github.com/sghael/2930380
    private val androidColors = hashMapOf(
        "white" to "#FFFFFF",
        "ivory" to "#FFFFF0",
