...
You can search for it in the plugins section inside Android Studio o directly from the marketplace.

[![Marketplace](./screenshots/marketplace.svg)](https://plugins.jetbrains.com/plugin/26174-telescope)
